...
public class CreateNoteInput implements GitLabInputRequest {
    ...
    public CreateNoteInput setClientMutationId(String clientMutationId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(clientMutationId, noteableId, body, internal, discussionId, mergeRequestDiffHeadSha);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(clientMutationId, other.clientMutationId) && Objects.equals(noteableId, other.noteableId) && Objects.equals(body, other.body) && Objects.equals(internal, other.internal) && Objects.equals(discussionId, other.discussionId) && Objects.equals(mergeRequestDiffHeadSha, other.mergeRequestDiffHeadSha);
    }

    @Override
    public String toString() {
        return "CreateNoteInput [clientMutationId=" + clientMutationId + ", noteableId=" + noteableId + ", body=" + body + ", internal=" + internal + ", discussionId=" + discussionId + ", mergeRequestDiffHeadSha=" + mergeRequestDiffHeadSha + "]";
    }
