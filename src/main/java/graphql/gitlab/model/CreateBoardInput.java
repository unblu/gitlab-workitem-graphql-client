...
public class CreateBoardInput {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(projectPath, groupPath, name, hideBacklogList, hideClosedList, assigneeId, milestoneId, iterationId, iterationCadenceId, weight, labelIds);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(projectPath, other.projectPath) && Objects.equals(groupPath, other.groupPath) && Objects.equals(name, other.name) && Objects.equals(hideBacklogList, other.hideBacklogList) && Objects.equals(hideClosedList, other.hideClosedList) && Objects.equals(assigneeId, other.assigneeId) && Objects.equals(milestoneId, other.milestoneId) && Objects.equals(iterationId, other.iterationId) && Objects.equals(iterationCadenceId, other.iterationCadenceId) && Objects.equals(weight, other.weight) && Objects.equals(labelIds, other.labelIds);
    }

    @Override
    public String toString() {
        return "CreateBoardInput [projectPath=" + projectPath + ", groupPath=" + groupPath + ", name=" + name + ", hideBacklogList=" + hideBacklogList + ", hideClosedList=" + hideClosedList + ", assigneeId=" + assigneeId + ", milestoneId=" + milestoneId + ", iterationId=" + iterationId + ", iterationCadenceId=" + iterationCadenceId + ", weight=" + weight + ", labelIds=" + labelIds + "]";
    }
